...
Revision ID: 2b76acfd702e
Revises: 
Create Date: 2025-03-08 21:14:49.825941
...
def upgrade() -> None:
    ...
    sa.Column('borrowed_date', sa.Date(), server_default=sa.text('CURRENT_DATE'), nullable=False),
    sa.Column('actual_return_date', sa.Date(), server_default=sa.text("CURRENT_DATE + INTERVAL '10 DAY'"), nullable=False),
